...
function generate() {
    ...
    // 同時保留一個簡易版存放在 lib 供 API 快速參考結構（可選，但這裡我們改用 fetch 模式）
    console.log(`✅ 所有分片已生成於: ${PUBLIC_DIR}`);
}
