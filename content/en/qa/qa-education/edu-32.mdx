...
## Strategy: Teacher Tip

In modern iPadOS, if a student enters an incorrect passcode 5 times, the iPad displays a "Connect to School Network" prompt. If it stays on Wi-Fi, a teacher's "Clear Passcode" command usually takes effect within 5 seconds, minimizing classroom disruption.
