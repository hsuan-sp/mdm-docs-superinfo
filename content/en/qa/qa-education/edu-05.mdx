...
3. **Background Activity (Apple Intelligence)**:
   - On newer iPads (M-series, modern iPadOS), the system may be indexing data for school-managed AI features. If the iPad is warm and slow after a major update, plug it into power and leave it on Wi-Fi overnight to finish the process.
