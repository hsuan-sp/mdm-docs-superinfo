...
Think of this as the school's**"Shared Resource Library."**

Instead of every individual student having to travel all the way to the main city library (Apple's servers in the US) to get the same textbook (an update), one person goes to get it and leaves a copy at the school’s front desk.
