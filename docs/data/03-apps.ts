...
`
      },
      {
        ...
        answer: `
**大部署環境下（如開學第一天），數百台 iPad 同時下載 App 會導致網路癱瘓。建議採用「分層派送」策略。**
...
*   **來源**：學生在個人裝置或未受限制的設備上，登入私人的 Apple ID 購買。
*   **所有權**：授權永久屬於 **該學生個人**。
*   **畢業離校處理**：
...
`
      ...
      {
        id: 'app-22',
        question: '【番外篇-實務採購常見狀況】Procreate 與 Procreate Pocket 有什麼差別？學校買錯了怎麼辦？',
