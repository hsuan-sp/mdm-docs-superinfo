...
## Term Definition**App Thinning**is an Apple optimization technology designed to minimize the storage footprint of applications. It consists of three pillars:
