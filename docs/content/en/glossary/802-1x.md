...
term: 802.1X
---
## Term Definition***802.1X**is an IEEE standard for port-based**Network Access Control (PNAC)**. It provides a robust authentication mechanism for devices wishing to attach to a LAN or WLAN.
...
Think of 802.1X as an**"Airport Security Checkpoint"**for your network.***Standard home Wi-Fi**is like a house key—anyone who has the key can walk in.***802.1X**requires everyone to show their own**passport**(certificate) and**ticket**(credentials).
