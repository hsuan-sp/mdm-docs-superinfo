...
Think of a Script as a**"Special Magic Spell."**

The standard control panel has buttons for normal things like "Volume" or "Brightness." But sometimes, you have a weird problem that doesn't have a button.
