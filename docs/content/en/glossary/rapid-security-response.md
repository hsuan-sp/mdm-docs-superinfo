...
Think of this as a**"Digital Emergency Band-Aid."**

Instead of performing a major multi-hour surgery (a full system update) that forces you to stop working, Apple can quickly slap on a small "patch" to fix a specific cut (security hole).
