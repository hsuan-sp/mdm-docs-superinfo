...
Consequences:***Deletion**: Permanently erases all user data, apps, accounts, and settings.***Reset**: Returns the operating system to its "out-of-box" state ("Hello" screen).***Security**: Used as a last resort for lost/stolen devices to prevent data theft.***lifecycle**: Used at the end of a school year to prepare an iPad for a new student.
