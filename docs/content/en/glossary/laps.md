...
Think of this as an**"Automatic Lock-Changing System."**

In the past, every classroom door in a school might have used the same "Master Key." If a thief stole that key, they could enter every room.
