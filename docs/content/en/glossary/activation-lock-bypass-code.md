...
***An IT administrator can enter this specific code in the password field to bypass the lock.*****This allows the device to be erased and prepared for a new user.**## Analogy
