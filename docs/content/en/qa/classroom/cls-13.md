...
3. **Wipe on Logout**: This is the most important feature.**Once the user logs out, all guest data is permanently wiped and cannot be recovered.**## Use Cases:***Public kiosks in the library.*****Temporary sessions for younger students who haven't yet received Managed Apple Accounts.**## Configuration:
