...
***This is by design to ensure accessibility and visibility across varying lighting environments.*****Advice**: Teachers should instruct students to enable "Auto-Brightness" or manually adjust it via Control Center.
