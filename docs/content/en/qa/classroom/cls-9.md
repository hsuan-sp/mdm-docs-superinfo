...
## 2. Screen Brightness***NOT Manageable**: Currently, there is no MDM command to lock brightness at a specific percentage (e.g., 50%).***This is by design to ensure accessibility and visibility across varying lighting environments.*****Advice**: Teachers should instruct students to enable "Auto-Brightness" or manually adjust it via Control Center.

## 3. Wallpaper***Manageable**: MDM can unify the Lock Screen and Home Screen wallpapers (Supervised devices only). This helps in identifying school assets visually.
