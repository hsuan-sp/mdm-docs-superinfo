...
4. In the**Users**list, use "Search" or "Filter" to locate students of a specific grade or class.
5. Select multiple students using keyboard shortcuts (hold**Command**or**Ctrl**, or use**Shift**for range selection).
6. Click**Change Account Status**in the panel to deactivate the entire class at once.
