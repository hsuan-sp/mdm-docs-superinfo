...
***Procedure**:
***Step 1: Add and Verify the New Domain**1. Log in to Apple School Manager ([school.apple.com](https://school.apple.com)).
...
***Step 2: Batch Update Account Formats*****For Manually Managed Accounts**:
...
***Step 3: Client-Side Action*****Forced Re-login**: After the change, iPhones/iPads will prompt "Account Verification Failed" or request a password.
