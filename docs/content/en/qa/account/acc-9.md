...
## Answer**This usually indicates a breakdown in communication between the device and the MDM server or Apple's services. Please check the following four core areas in order:****Check 1: APNs Certificate Status*** Log in to Jamf Pro and navigate to**Settings > Global Management > Push Certificates**.
