...
1.**Crucial Step**: Log in with the**EXACT SAME Apple ID**used to create the original certificate.**Warning: If you use a different ID, you will create a new certificate rather than a renewal, which will break the connection to your existing iPads.*
