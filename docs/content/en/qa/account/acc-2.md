...
***Warning: If you use a different ID, you will create a new certificate rather than a renewal, which will break the connection to your existing iPads.**4.**Renew**: Find the certificate that matches your Jamf server, click**"Renew,"**and upload the CSR from Step 1.
