...
## Answer**The recovery method depends on your Jamf Pro deployment (Cloud vs. On-Premise) and whether SSO is enabled.****Scenario 1: Jamf Pro Cloud (Jamf Cloud)**1.**Use the Login Page Link**:
