...
title: >-
  Do Managed Apple Accounts support Multi-Factor Authentication (MFA)? How is it
  managed?
---
## Q: Do Managed Apple Accounts support Multi-Factor Authentication (MFA)? How is it managed?

## Answer***Yes. Managed Apple Accounts support MFA via managed recovery phones or Federated Authentication.**Enabling MFA is a basic security standard for high-privilege accounts, such as administrators or teachers.
