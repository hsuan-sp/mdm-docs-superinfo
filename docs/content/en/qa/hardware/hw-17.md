...
## Answer**Yes. Jamf Pro integrates with Apple’s Global Service Exchange (GSX) database to automatically pull 'Limited Warranty' status for every device.**This is extremely helpful for auditing the Digital Initiative fleet in 2026.
