...
tags:
  ...
  - HDMI
title: >-
  How do I project my iPad screen to a traditional TV or a classroom without
  Apple TV?
---
...
4. The iPad screen will automatically mirror.***Pros**:***Near-zero latency, great for live demos.*****No network required.*****Compatible with any TV/Projector with an HDMI port.*****Cons**:***Requires carrying an adapter and cable.*****The iPad is tethered to the cable length.**
