...
## Q: How do students submit their work (Keynote/Pages) to the teacher?

## Answer**The best method is via cloud storage (Google Drive, OneDrive, or iCloud Drive). Other options include AirDrop, Google Classroom assignments, or a school-designated submission portal.**In a digital learning environment, a smooth submission flow is key to efficiency.
...
1. In Keynote/Pages, tap**Share**(the share icon).
1. Select**Save to Files**.
1. In the Files app, select**Google Drive**(Enable it via the "..." menu if it doesn't appear).
1. Save to the folder designated by the teacher.
...
1. Select the file from the**Files**app.
1. Tap**Hand In**.
