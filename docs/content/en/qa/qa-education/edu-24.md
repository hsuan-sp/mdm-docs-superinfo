...
***Strategy B: App Lock (Single App Mode)**Using the**Classroom**app's**'App Lock'**feature is the most secure method:

***When locked into a single app, the system-wide text selection menu is suppressed, and the student cannot access the Writing Tools interface. This is effective for both school-owned and BYOD devices.**## Device Capability Audit:
