...
1. **Cross-Test with Hotspot**:***Connect the iPad to a mobile hotspot.*****Result**: If it works on a hotspot, the iPad is fine—the issue is the school's Wi-Fi or DNS config.

1. **Check Content Filters**:***If the school uses**Jamf Trust**, ensure it shows "Protected." A crash in the filtering app can block all traffic. Try restarting the iPad.
