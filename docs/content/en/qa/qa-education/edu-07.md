...
***It uses DNS Proxy technology at the system level.*****Background processes are highly optimized.*****Under**Settings > Battery**, Jamf Trust typically accounts for less than 1% of usage.
