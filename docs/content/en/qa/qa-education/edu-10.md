...
---
## Q: Why is the App Store missing? How do I download apps?
...
## How to Install Apps: Using Self Service***Self Service**is Jamf's "School App Store." Administrators choose which apps are available for students and staff.***Steps**:
...
## Benefits of Self Service:***No Password Required**: Uses silent VPP licensing.***Vetted Apps**: Only school-approved apps appear.***Instant Updates**: Admins can push new apps or updates remotely.
...
## Troubleshooting:***Self Service won't open**: Check your internet connection and try restarting the iPad.***Install button is grey**: Licensing may be low or a background process is active; try again later.***Can't find Self Service**: Check inside folders or the second page. You can also use Spotlight to search for it.
