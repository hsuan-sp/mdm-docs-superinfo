...
1. **Check Control Center Settings**:***If not restricted but still missing, the button might not be in the menu.*****Fix**: Go to**Settings > Control Center**and tap the green**+**next to**Screen Recording**.

1. **Check Screen Time**:***If a student (or parent) enabled local Screen Time restrictions, this can also block the feature. Check**Settings > Screen Time > Content & Privacy Restrictions**.
