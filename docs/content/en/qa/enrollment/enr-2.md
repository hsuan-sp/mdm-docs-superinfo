...
1.**Prepare**: Use the "Prepare" wizard and select**"Add to Apple School Manager."**1.**Wipe & Bridge**: This process**will erase the device**. Once completed, the device enters a 30-day "provisional period" during which the user can still opt-out. After 30 days, the device is permanently merged into your ASM organization as a fully Supervised asset.
