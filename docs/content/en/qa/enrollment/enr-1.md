...
title: >-
  My new iPad didn't show the 'Remote Management' screen during setup. How do I
  fix this?
---
...
If the device has already reached the Home Screen (skipping management):***The device must be erased**: Go to**Settings > General > Transfer or Reset iPad > Erase All Content and Settings**.
