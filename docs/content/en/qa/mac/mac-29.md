...
***Before the deadline, users will receive gentle system notifications.*****Once the deadline is reached, the device will ignore the user's state, force a restart, and install the update.**1. Assign this blueprint to the target device group.
