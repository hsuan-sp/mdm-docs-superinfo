...
## Answer**This is a common requirement for asset branding. We recommend using 'Automated Management' to set the image and 'Restrictions' to lock the permission.**## Implementation Steps (Jamf Pro):
