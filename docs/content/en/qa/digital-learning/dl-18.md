...
***In Jamf Pro, go to the device record.*****Click**Management > Remote Commands > Clear Passcode**.

1.**Result**:

***Within 3-5 seconds, the iPad screen should flicker.*****The passcode is removed. You can swipe to enter the Home Screen immediately.*****Note: Biometric data (Touch ID / Face ID) is also cleared and must be re-registered.**## What if the iPad has no internet?
