...
**As the Digital Initiative enters its final contract year, hardware failures will reach their peak. If a device shows no signs of accidental damage, you must report it early to secure a replacement or repair before the contract expires.**

After four years of high-intensity classroom use, various internal components in the initial iPad 9 batch are reaching their natural limit. IT Coordinators should audit their fleet for the following:
