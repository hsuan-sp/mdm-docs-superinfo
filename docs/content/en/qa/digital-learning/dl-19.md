...
tags:
  ...
  - mDNS
title: >-
  Troubleshooting: Apple Classroom keeps losing student connections or showing
  'Offline'.
---
...
## Phase 2: MDM Profile Check***Education Profile**: Go to**Settings > General > VPN & Device Management**and verify the "Education Profile" is present and has not expired.***Inventory Update**: If the roster is incorrect, send an**Update Inventory**command to the class in Jamf Pro to force a re-sync of the educational configuration.

## Phase 3: School Network Environment***If the devices are local and configured correctly but still won't talk, the Wi-Fi infrastructure is likely blocking**mDNS (Bonjour)**.***Action**: IT coordinators often cannot fix this at the school level. Contact your regional network center or vendor and request that they allow**mDNS Relay**and open**TCP/UDP Ports 3283 and 3284**. Ensure "Client Isolation" is disabled for the classroom VLAN.
