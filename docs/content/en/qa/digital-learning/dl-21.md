...
When a student graduates and the device must be reassigned, use the ** Return to Service (RTS)

**feature. This is the fastest way to reset a device in** iOS 26 **.** The Return to Service Advantage ** :
