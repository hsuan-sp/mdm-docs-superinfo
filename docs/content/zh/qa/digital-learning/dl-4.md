...
## Answer**智慧型群組 (Smart Group) 是管理大量精進方案載具的核心工具，****能根據「資產標籤」或「採購年度」自動歸類裝置。**透過智慧型群組，您可以精準地對「112 年度採購」或「114 年度擴充」的裝置派送不同的 App 與限制。**建立邏輯與範例**：
...
***用途**：可用來反向篩選「未安裝 Jamf Trust」的裝置，作為異常排除清單。**操作路徑**：
