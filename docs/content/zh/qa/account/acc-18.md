...
## Answer***不需要重新購買。App 授權是綁定在 ASM 的「位置 (Location)」上，而非特定的 MDM 軟體。**只要您的 App 授權仍在 Apple 校務管理的後台內，就可以在不同 MDM 之間流轉。***標準轉移流程**：
...
3.**同步內容**：新 MDM 會立即抓取到 ASM 中剩餘的授權數量。***進階技術 (MDM Migration API)**：
