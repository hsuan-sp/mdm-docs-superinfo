...
***場景一：電腦教室 / 公用電腦 (Device-Based Licensing)**電腦教室必須讓學生「坐下即用」，不能要求學生登入微軟帳號。
...
***場景二：教職員 / 行政電腦 (User-Based Licensing)**行政同仁通常擁有個人的 Microsoft 365 (A3/A5) 帳號。
...
***實務建議：專家提示**若發生「授權衝突」，通常是因為電腦同時殘留了舊版的 Serializer 與新版登入資訊。
