      ...
      <div className="relative space-y-12">
        ...
        {filteredLogs.map((log, index) => (
          <article key={log.version} className="relative md:pl-48 group">
            ...
            <div
              className={`apple-card-content group relative overflow-hidden p-8 md:p-10 transition-all duration-300 ${index === 0 && selectedVersion === "ALL" ? "ring-2 ring-apple-blue/20 dark:ring-apple-blue/10 shadow-xl" : ""}`}
            >
